...
> [!NOTE]  
> This document describes how to deploy the **upstream AnythingLLM** project (MIT-licensed, by Mintplex Labs) on DigitalOcean using Terraform.  
> In the **Alata Studio** repository, it is kept as an upstream deployment template for reference.  
> If you follow these steps as-is, you will deploy the upstream `mintplexlabs/anythingllm` image, **not** an Alata Studio–branded image.
