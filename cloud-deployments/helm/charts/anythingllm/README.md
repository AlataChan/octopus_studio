...
> [!NOTE]  
> This Helm chart deploys the **upstream AnythingLLM** project (MIT-licensed, by Mintplex Labs).  
> In the **Alata Studio** repository, it is included as an upstream deployment template for reference.  
> If you install this chart as-is, you will run the upstream `mintplexlabs/anythingllm` image, **not** an Alata Studio–branded image.
