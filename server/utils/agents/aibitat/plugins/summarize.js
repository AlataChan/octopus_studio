    ...
    return {
      ...
      setup(aibitat) {
        aibitat.function({
          ...
          description:
            "List and summarize documents in the workspace's knowledge base (embedded/vectorized documents). Do NOT use this for data analysis files (CSV/Excel with paths like 'workspace-{id}/...') - use duckdb-list-files and duckdb-query for those instead.",
          examples: [
            {
