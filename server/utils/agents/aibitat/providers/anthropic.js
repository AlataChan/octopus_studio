    ...
    try {
      ...
      for await (const chunk of response) {
        ...
        if (chunk.type === "content_block_delta") {
          // Cap2: extended thinking — emit reasoning event, do NOT enter textResponse
          if (chunk.delta.type === "thinking_delta") {
            eventHandler?.("reasoning", { content: chunk.delta.thinking || "" });
            continue;
          }

          // Cap2: signature_delta (integrity token for thinking block) — safe-ignore
