...
-- CreateIndex
CREATE UNIQUE INDEX "channel_accounts_provider_accountId_key" ON "channel_accounts"("provider", "accountId");

-- CreateIndex
CREATE INDEX "channel_accounts_provider_status_idx" ON "channel_accounts"("provider", "status");

-- CreateIndex
CREATE INDEX "channel_bindings_provider_accountId_priority_idx" ON "channel_bindings"("provider", "accountId", "priority");

-- CreateIndex
CREATE INDEX "channel_bindings_workspaceId_idx" ON "channel_bindings"("workspaceId");

-- CreateIndex
CREATE UNIQUE INDEX "channel_sessions_sessionKey_key" ON "channel_sessions"("sessionKey");

-- CreateIndex
CREATE INDEX "channel_sessions_provider_accountId_peerId_idx" ON "channel_sessions"("provider", "accountId", "peerId");

-- CreateIndex
CREATE INDEX "channel_sessions_provider_accountId_peerId_senderId_idx" ON "channel_sessions"("provider", "accountId", "peerId", "senderId");

-- CreateIndex
CREATE INDEX "channel_sessions_bindingId_idx" ON "channel_sessions"("bindingId");

-- CreateIndex
CREATE INDEX "channel_sessions_threadId_idx" ON "channel_sessions"("threadId");

-- CreateIndex
CREATE UNIQUE INDEX "channel_message_events_provider_accountId_eventId_key" ON "channel_message_events"("provider", "accountId", "eventId");

-- CreateIndex
CREATE INDEX "channel_message_events_provider_accountId_createdAt_idx" ON "channel_message_events"("provider", "accountId", "createdAt");

-- CreateIndex
CREATE INDEX "channel_message_events_bindingId_createdAt_idx" ON "channel_message_events"("bindingId", "createdAt");
