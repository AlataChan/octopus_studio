...
const AGENT_FLOW_RUN_ENABLED = process.env.AGENT_FLOW_RUN_ENABLED === "true";
const AGENT_FLOW_RUN_ROUTES = [
  "/agent-flows/run",
  "/agent-flows/test-run",
  "/agent-flows/execute",
  "/agent-flows/public-run",
  "/agent-flows/:uuid/run",
  "/agent-flows/:uuid/test-run",
  "/agent-flows/:uuid/execute",
  "/agent-flows/:uuid/public-run",
];

function unavailableRunEndpoint(_request, response) {
  if (!AGENT_FLOW_RUN_ENABLED) {
...
function agentFlowEndpoints(app) {
  ...
  for (const route of AGENT_FLOW_RUN_ROUTES) {
    app.all(route, unavailableRunEndpoint);
  }
