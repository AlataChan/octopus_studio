...
const DEFAULT_SETTINGS = {
  ...
  sponsorText: "Powered by Alata", // default sponsor text
  sponsorLink: "https://alata.studio", // default sponsor link
  position: "bottom-right", // position of chat button/window
  assistantName: "Alata Chat Assistant", // default assistant name
  ...
  useEffect(() => {
    function fetchAttribs() {
      ...
      if (
        ...
        throw new Error(
          "[Alata Embed::Abort] - Invalid script tag setup detected. Missing required parameters for boot!"
        );
