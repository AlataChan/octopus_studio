...
export const embedderSettings = {
  ...
  USER_STYLES: {
    msgBg: scriptSettings?.userBgColor ?? "#00D9FF",
    base: `allm-text-white allm-rounded-t-[18px] allm-rounded-bl-[18px] allm-rounded-br-[4px] allm-mx-[20px]`,
  },
  ASSISTANT_STYLES: {
    msgBg: scriptSettings?.assistantBgColor ?? "#FEFEFE",
    base: `allm-text-[#013153] allm-rounded-t-[18px] allm-rounded-br-[18px] allm-rounded-bl-[4px] allm-mr-[37px] allm-ml-[9px]`,
  },
};
