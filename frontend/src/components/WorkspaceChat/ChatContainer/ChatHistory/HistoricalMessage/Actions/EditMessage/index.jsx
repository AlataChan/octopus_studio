  ...
  return (
    ...
    >
      <button
        ...
        className="border-none text-theme-text-secondary"
        aria-label={label}
      >
        <Pencil
  ...
  return (
    <form onSubmit={handleSaveMessage} className="flex flex-col w-full">
      <textarea
        ...
        className="text-theme-text-primary w-full rounded bg-theme-bg-secondary border border-theme-border-medium active:outline-none focus:outline-none focus:ring-0 pr-16 pl-1.5 pt-1.5 resize-y"
      ...
      <div className="mt-3 flex justify-center">
        ...
        <button
          type="button"
          className="border-none px-2 py-1 bg-historical-msg-system text-theme-text-primary font-medium rounded-md hover:bg-historical-msg-user/90 light:hover:text-theme-text-primary focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
          onClick={cancelEdits}
        >
