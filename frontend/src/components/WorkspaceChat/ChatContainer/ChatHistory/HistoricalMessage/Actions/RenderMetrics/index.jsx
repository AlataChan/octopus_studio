...
const SHOW_METRICS_KEY = "alata_show_chat_metrics";
const SHOW_METRICS_EVENT = "alata_show_metrics_change";
...
function getAutoShowMetrics() {
  return getLocalStorageItem(SHOW_METRICS_KEY) === "true";
}

/**
 * Toggle the show metrics setting in localStorage.
 * @returns {void}
 */
function toggleAutoShowMetrics() {
  const currentValue = getAutoShowMetrics() || false;
  setLocalStorageItem(SHOW_METRICS_KEY, !currentValue);
