              ...
              {isThinking || isComplete ? (
                <>
                  <video
                    ...
                    data-tooltip-content={t("chat_window.model_thinking")}
                    aria-label={t("chat_window.model_thinking")}
                  >
                    <source src={ThinkingAnimation} type="video/webm" />
                  </video>
                  <img
                    src={ThinkingStatic}
                    alt={t("chat_window.model_finished_thinking")}
                    ...
                    data-tooltip-content={t(
                      "chat_window.model_finished_thinking"
                    )}
                    aria-label={t("chat_window.model_finished_thinking")}
                  />
                </>
              ) : null}
            </div>
