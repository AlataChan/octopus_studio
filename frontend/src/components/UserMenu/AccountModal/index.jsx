...
export default function AccountModal({ user, hideModal }) {
  ...
  const handleUpdate = async (e) => {
    ...
    if (success) {
      let storedUser = JSON.parse(getLocalStorageItem(AUTH_USER));
      if (storedUser) {
        storedUser.username = data.username;
        storedUser.bio = data.bio;
        setLocalStorageItem(AUTH_USER, JSON.stringify(storedUser));
      }
            ...
            <div className="flex flex-col gap-y-4 px-6">
              <div>
                ...
                <input
                  name="username"
                  type="text"
                  className="border-none bg-theme-settings-input-bg placeholder:text-theme-settings-input-placeholder border-theme-border text-theme-text-primary text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5"
              ...
              <div>
                ...
                <textarea
                  name="bio"
                  className="border-none bg-theme-settings-input-bg placeholder:text-theme-settings-input-placeholder border-theme-border text-theme-text-primary text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5 min-h-[100px] resize-y"
