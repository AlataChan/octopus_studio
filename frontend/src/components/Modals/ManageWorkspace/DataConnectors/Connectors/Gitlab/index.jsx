        ...
        <form className="w-full" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col pr-10">
                ...
                <div className="flex items-center gap-x-2 mb-3">
                  <label className="relative inline-flex cursor-pointer items-center">
                    ...
                    <span className="ml-3 text-sm font-medium text-theme-text-primary">
          ...
          <div className="flex flex-col gap-y-2 w-full pr-10">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 w-full justify-center border-none px-4 py-2 rounded-lg text-dark-text light:text-theme-text-primary text-sm font-bold items-center flex gap-x-2 bg-theme-home-button-primary hover:bg-theme-home-button-primary-hover disabled:bg-theme-home-button-primary-hover disabled:cursor-not-allowed"
            >
    ...
    return (
      <div className="flex flex-col w-60">
        ...
        <select
          name="branch"
          required={true}
          className="border-none bg-theme-settings-input-bg border-theme-border text-theme-text-primary focus:outline-primary-button active:outline-primary-button outline-none text-sm rounded-lg block w-full p-2.5"
        >
