...
const ManageWorkspace = ({ hideModal = noop, providedSlug = null }) => {
  ...
  return (
    <div className="fixed inset-0 z-99 overflow-y-auto">
      ...
      <div className="relative z-20 min-h-full w-full flex justify-center items-start px-4 py-10">
        <div className="relative bg-theme-bg-secondary rounded-[12px] shadow border-2 border-theme-modal-border max-w-[calc(100vw-32px)] overflow-x-auto">
        ...
        <button
          ...
          className={`border-none px-4 py-2 rounded-[8px] font-semibold hover:bg-theme-modal-border hover:bg-opacity-60 ${
            selectedTab === "documents"
              ...
              : "text-white/20 font-medium hover:text-theme-text-primary light:bg-white light:text-[#535862] light:hover:bg-[#E0F2FE]"
          }`}
        >
