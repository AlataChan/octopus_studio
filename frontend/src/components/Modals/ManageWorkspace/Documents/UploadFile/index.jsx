...
export default function UploadFile({
  ...
  return (
    <div>
      <div
        className={`w-full xl:w-[560px] border-dashed border-[2px] border-theme-modal-border light:border-[#686C6F] rounded-2xl bg-theme-bg-primary transition-colors duration-300 p-3 ${
          ready
      ...
      >
        ...
        {ready === false ? (
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <div className="text-theme-text-primary text-opacity-60 text-xs font-medium py-1 px-20 text-center">
      ...
      <div className="text-center text-theme-text-primary text-opacity-50 text-xs font-medium w-full xl:w-[560px] py-2">
      ...
      <form onSubmit={handleSendLink} className="flex gap-x-2">
        ...
        <button
          disabled={fetchingUrl}
          type="submit"
          className="disabled:bg-white/20 disabled:text-theme-text-secondary disabled:border-slate-400 disabled:cursor-wait bg bg-transparent hover:bg-slate-200 hover:text-slate-800 w-auto border border-white light:border-theme-modal-border text-sm text-theme-text-primary p-2.5 rounded-lg"
        >
          {fetchingUrl
      ...
      <div className="mt-6 text-center text-theme-text-primary text-opacity-80 text-xs font-medium w-full xl:w-[560px]">
