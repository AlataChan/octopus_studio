...
function FileUploadProgressComponent({
  ...
  return (
    <div
      className={`${
        isFadingOut ? "file-upload-fadeout" : "file-upload"
      } h-14 px-2 py-2 flex items-center gap-x-4 rounded-lg bg-theme-bg-secondary light:border-solid light:border-theme-modal-border light:bg-theme-bg-sidebar border border-theme-border-medium shadow-md`}
    >
      <div className="w-6 h-6 flex-shrink-0">
        {status !== "complete" ? (
