    ...
    <>
      <div className="px-8 pb-8" onContextMenu={handleContextMenu}>
        <div className="flex flex-col gap-y-6">
          <div className="flex items-center justify-between w-full xl:w-[560px] px-5 relative">
          ...
          <div className="relative w-full xl:w-[560px] h-[310px] bg-theme-settings-input-bg rounded-2xl overflow-hidden border border-theme-modal-border">
            <div className="absolute top-0 left-0 right-0 z-10 rounded-t-2xl text-theme-text-primary text-xs grid grid-cols-12 py-2 px-8 border-b border-theme-border-medium light:border-theme-modal-border bg-theme-settings-input-bg">
            ...
            <div className="overflow-y-auto h-full pt-8">
              {loading ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <p className="text-theme-text-primary text-opacity-40 text-sm font-medium">
                ...
                <div className="mx-auto bg-white/40 light:bg-white rounded-lg py-1 px-2 pointer-events-auto light:shadow-lg">
                  <div className="flex flex-row items-center gap-x-2">
                    <button
                      ...
                      className="border-none text-sm font-semibold bg-white light:bg-[#E0F2FE] h-[30px] px-2.5 rounded-lg hover:bg-neutral-800/80 hover:text-theme-text-primary light:text-[#026AA2] light:hover:bg-[#026AA2] light:hover:text-theme-text-primary"
                    >
                    ...
                    <div className="relative">
                      <button
                        ...
                        className="border-none text-sm font-semibold bg-white light:bg-[#E0F2FE] h-[32px] w-[32px] rounded-lg text-dark-text hover:bg-neutral-800/80 hover:text-theme-text-primary light:text-[#026AA2] light:hover:bg-[#026AA2] light:hover:text-theme-text-primary flex justify-center items-center group"
                      >
                    ...
                    <button
                      onClick={deleteFiles}
                      className="border-none text-sm font-semibold bg-white light:bg-[#E0F2FE] h-[32px] w-[32px] rounded-lg text-dark-text hover:bg-neutral-800/80 hover:text-theme-text-primary light:text-[#026AA2] light:hover:bg-[#026AA2] light:hover:text-theme-text-primary flex justify-center items-center"
                    >
      ...
      render={({ content }) => {
        ...
        return (
          <div className="text-xs">
            <p className="text-theme-text-primary light:invert font-medium break-all">
              {data.title}
            </p>
