...
function WorkspaceDirectory({
  ...
  if (loading) {
    return (
      <div className="px-8">
        <div className="flex items-center justify-start w-full xl:w-[560px]">
          <h3 className="text-theme-text-primary text-base font-bold ml-5">
            {workspace.name}
          </h3>
        </div>
        <div className="relative w-full xl:w-[560px] h-[445px] bg-theme-settings-input-bg rounded-2xl mt-5 border border-theme-modal-border">
          <div className="text-white/80 text-xs grid grid-cols-12 py-2 px-3.5 border-b border-theme-border-medium light:border-theme-modal-border bg-theme-settings-input-bg sticky top-0 z-10 rounded-t-2xl">
  ...
  return (
    <>
      <div className="px-8">
        ...
        <div className="relative w-full xl:w-[560px] h-[445px] mt-5">
          <div
          ...
          <div className="relative w-full h-full bg-theme-settings-input-bg rounded-2xl overflow-hidden border border-theme-modal-border">
            <div className="text-white/80 text-xs grid grid-cols-12 py-2 px-3.5 border-b border-theme-border-medium light:border-theme-modal-border bg-theme-settings-input-bg sticky top-0 z-10">
              <div className="col-span-10 flex items-center gap-x-[4px]">
                {!hasChanges &&
        ...
        {hasChanges && (
          <div className="flex items-center justify-between py-6">
            ...
            <button
              ...
              className="border border-slate-200 px-5 py-2.5 rounded-lg text-theme-text-primary text-sm items-center flex gap-x-2 hover:bg-slate-200 hover:text-slate-800 focus:ring-gray-800"
            >
