      ...
      <div hidden={!showAdvancedControls}>
        <div className="flex flex-col">
          <div className="w-full flex items-start gap-4">
            ...
            <div className="flex flex-col w-60">
              <label className="text-theme-text-primary text-sm font-semibold mb-2 flex items-center">
                Performance Mode
                <Info
                  size={16}
                  className="ml-2 text-theme-text-primary"
          ...
          <div className="w-full flex items-start gap-4 mt-4">
            <div className="flex flex-col w-100">
              ...
              <input
                ...
                className="border-none bg-theme-settings-input-bg mt-2 text-theme-text-primary placeholder:text-theme-settings-input-placeholder text-sm rounded-lg outline-none block w-full p-2.5 focus:outline-primary-button active:outline-primary-button"
    ...
    <div className="flex flex-col w-60">
      ...
      <select
        ...
        defaultValue={
          ...
          customModels.some((m) => m.id === settings.OllamaLLMModelPref)
            ? settings.OllamaLLMModelPref
            : customModels[0]?.id
        }
        className="border-none bg-theme-settings-input-bg border-theme-border text-theme-text-primary text-sm rounded-lg block w-full p-2.5"
