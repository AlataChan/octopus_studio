...
export default function EditingChatBubble({
  ...
  return (
    <div>
      <p
        className={`text-xs text-theme-text-primary light:text-black/80 ${isUser ? "text-right" : ""}`}
      >
        {isUser
          ? t("common.user")
      ...
      >
        <button
          className={`transition-all duration-300 absolute z-10 text-theme-text-primary rounded-full hover:bg-neutral-700 light:hover:invert hover:border-white border-transparent border shadow-lg ${
        ...
        <div
          className={`p-2 max-w-full md:w-[290px] text-black rounded-[8px] ${
            isUser
              ? "bg-[#41444C] text-theme-text-primary"
              : "bg-[#2E3036] text-theme-text-primary"
          }
        }`}
        ...
        >
          {isEditing ? (
            <input
              ...
              autoFocus
              className={`w-full light:text-theme-text-primary ${
                isUser
                  ? "bg-[#41444C] text-theme-text-primary"
                  : "bg-[#2E3036] text-theme-text-primary"
              }`}
