...
import { videoUnderstandingErrorMessage } from "./videoAttachments";
...
export default function handleChat(
  ...
  if (type === "abort" || type === "statusResponse") {
    const displayError = videoUnderstandingErrorMessage(chatResult) || error;
    ...
    console.log(
      "[Agent] Received agentInitWebsocketConnection, UUID:",
      chatResult.websocketUUID
    );
