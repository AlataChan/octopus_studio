...
export const ONBOARDING_SURVEY_URL =
  "https://github.com/AlataChan/octopus_studio";

export const AUTH_USER = "alata_user";
export const AUTH_TOKEN = "alata_authToken";
export const AUTH_TIMESTAMP = "alata_authTimestamp";
export const AUTH_SESSION_VALIDATED = "alata_authSessionValidated";
export const COMPLETE_QUESTIONNAIRE = "alata_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "alata_pinned_document_alert";
export const SEEN_WATCH_ALERT = "alata_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "alata_last_visited_workspace";

export const APPEARANCE_SETTINGS = "alata_appearance_settings";
