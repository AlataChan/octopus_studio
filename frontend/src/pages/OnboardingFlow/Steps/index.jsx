...
export function OnboardingLayout({ children }) {
  ...
  if (isMobile) {
    return (
      <div
        ...
        className="w-screen h-screen overflow-y-auto bg-page-texture overflow-hidden"
      >
          ...
          <div className="flex w-full justify-center gap-x-4 pb-20">
            <div className="flex justify-center items-center">
              {backBtn.showing && (
                ...
                >
                  <ArrowLeft
                    className="text-theme-text-primary group-hover:text-black group-disabled:text-theme-text-secondary"
                    size={30}
                  />
                </button>
              )}
            ...
            <div className="flex justify-center items-center">
              {forwardBtn.showing && (
                ...
                >
                  <ArrowRight
                    className="text-theme-text-primary group-hover:text-teal group-disabled:text-theme-text-secondary"
                    size={30}
                  />
                </button>
              )}
  ...
  return (
    <div
      data-layout="onboarding"
      className="w-screen overflow-y-auto bg-page-texture flex justify-center overflow-hidden"
    >
      <div className="relative z-[1] flex w-1/5 h-screen justify-center items-center">
        {backBtn.showing && (
          <button
            disabled={backBtn.disabled}
            onClick={backBtn.onClick}
          ...
          >
            <ArrowLeft
              className="text-theme-text-secondary group-hover:text-theme-text-primary group-disabled:text-theme-text-secondary"
              size={30}
            />
          </button>
        )}
