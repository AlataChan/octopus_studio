...
export const VECTOR_DB_PRIVACY = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of Octopus Studio",
    ],
    logo: LanceDbLogo,
  },
};
...
export const EMBEDDING_ENGINE_PRIVACY = {
  native: {
    ...
    description: [
      "Your document text is embedded privately on this instance of Octopus Studio",
    ],
...
export const FALLBACKS = {
  LLM: (provider) => ({
    name: "Unknown",
    description: [
      `"${provider}" has no known data handling policy defined in Octopus Studio`,
    ],
    logo: OctopusStudioIcon,
  }),
  EMBEDDING: (provider) => ({
