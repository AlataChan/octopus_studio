...
import OctopusStudioLogo from "@/media/logo/octopus-studio-lockup-navy.png";
...
export default function OnboardingHome() {
  ...
  return (
    <>
      <div className="relative w-screen h-screen flex overflow-hidden bg-page-texture">
        <div
