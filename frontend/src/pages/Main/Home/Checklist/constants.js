...
export const CHECKLIST_UPDATED_EVENT = "alata_checklist_updated";
export const CHECKLIST_STORAGE_KEY = "alata_checklist_completed";
export const CHECKLIST_HIDDEN = "alata_checklist_dismissed";
export const CHECKLIST_COLLAPSED_KEY = "alata_checklist_collapsed";
