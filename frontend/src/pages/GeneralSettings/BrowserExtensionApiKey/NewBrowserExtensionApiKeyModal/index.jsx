            ...
            <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2">
              ...
              {apiKey && (
                <input
                  ...
                  defaultValue={apiKey}
                  disabled={true}
                  className="border-none bg-theme-settings-input-bg w-full text-theme-text-primary placeholder:text-theme-settings-input-placeholder text-sm rounded-lg block w-full p-2.5"
                />
              )}
              {isMultiUser && (
              ...
              <p className="text-theme-text-primary text-opacity-60 text-xs md:text-sm">
                After clicking "Create API Key", Octopus Studio will attempt to connect
                to your browser extension automatically.
              </p>
              <p className="text-theme-text-primary text-opacity-60 text-xs md:text-sm">
                If you see "Connected to Octopus Studio" in the extension, the connection
