...
export default function AgentSkill({ item, settings, setStep }) {
  ...
  return (
    <div className="flex flex-col mt-4 gap-y-4">
      <div className="border border-theme-border light:border-orange-500/20 my-2 flex flex-col md:flex-row md:items-center gap-x-2 text-theme-text-primary light:text-orange-600 mb-4 bg-orange-800/30 light:bg-orange-500/10 rounded-lg px-4 py-2">
        <div className="flex flex-col gap-y-2">
          ...
          <p className="text-sm">
            Agent skills can execute code on your Octopus Studio instance, so only import
      ...
      <div className="flex flex-col gap-y-1">
        ...
        <div className="flex gap-x-1">
          ...
          <a
            href="https://github.com/AlataChan/octopus_studio.git"
            target="_blank"
      ...
      <div className="flex flex-col gap-y-[25px] text-white/80 light:text-theme-text-secondary text-sm">
        <p>
          Agent skills unlock new capabilities for your Octopus Studio workspace via{" "}
          <code className="font-mono bg-theme-bg-primary light:bg-slate-200 px-1 py-0.5 rounded-md text-sm">
            @agent
          </code>{" "}
