...
https://github.com/AlataChan/octopus_studio.git
-->
<script
...
<!-- Octopus Studio (https://alata.studio) -->
`;
}
  ...
  return (
    <div>
      ...
      <button
        disabled={copied}
        onClick={handleClick}
        className={`disabled:border disabled:border-green-300 disabled:light:border-green-600 border border-transparent relative w-full font-mono flex hljs ${theme} light:border light:border-theme-modal-border text-theme-text-primary placeholder:text-theme-settings-input-placeholder text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none p-2.5 m-1`}
      >
        <div
