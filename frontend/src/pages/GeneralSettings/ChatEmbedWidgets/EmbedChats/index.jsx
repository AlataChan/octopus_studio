...
const exportOptions = {
  csv: {
    ...
    fileExtension: "csv",
    filenameFunc: () => {
      return `alata-embed-chats-${new Date().toLocaleDateString()}`;
    },
  },
  json: {
    name: "JSON",
  ...
  jsonl: {
    ...
    fileExtension: "jsonl",
    filenameFunc: () => {
      return `alata-embed-chats-${new Date().toLocaleDateString()}-lines`;
    },
  },
  jsonAlpaca: {
    name: "JSON (Alpaca)",
    ...
    fileExtension: "json",
    filenameFunc: () => {
      return `alata-embed-chats-${new Date().toLocaleDateString()}-alpaca`;
    },
  },
};
        ...
        <div className="flex flex-wrap gap-4 items-center">
          ...
          <div className="relative">
            <button
              ref={openMenuButton}
              onClick={toggleMenu}
              className="flex items-center gap-x-2 px-4 py-1 rounded-lg text-theme-bg-chat bg-primary-button hover:bg-secondary hover:text-theme-text-primary text-xs font-semibold h-[34px] w-fit"
            >
