    ...
    <div className="relative w-full md:max-w-2xl max-h-full">
      <div className="w-full max-w-2xl bg-theme-bg-secondary rounded-lg shadow border-2 border-theme-modal-border overflow-hidden">
        ...
        <div className="w-full p-6">
          <div className="w-full h-[60vh] py-2 px-4 whitespace-pre-line overflow-auto rounded-lg bg-theme-bg-primary light:bg-theme-bg-secondary border border-theme-border text-theme-text-primary text-sm">
            {text}
          </div>
        </div>
      </div>
