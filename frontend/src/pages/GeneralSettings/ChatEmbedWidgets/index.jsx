        ...
        <div className="flex flex-col w-full p-4 mt-10">
          ...
          >
            <div className="text-theme-text-primary flex items-center gap-x-2">
              <p className="text-lg font-medium">{t("chat-embed.title")}</p>
            </div>
            <WidgetList
...
function WidgetList({ selectedView, handleClick, t }) {
  const views = {
    configs: {
      title: t("chat-embed.widgets"),
    },
    chats: {
      title: t("chat-embed.history"),
    },
  };
