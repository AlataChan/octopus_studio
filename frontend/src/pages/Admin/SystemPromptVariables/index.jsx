        ...
        <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:py-6 py-16">
          ...
          <div className="w-full justify-end flex">
            ...
            >
              ...
              {t("system-prompt-variables.add-variable")}
            </CTAButton>
          </div>
          ...
          <div className="overflow-x-auto">
            {loading ? (
              ...
              <div className="text-center py-4 text-theme-text-secondary">
                {t("system-prompt-variables.no-variables")}
              </div>
            ) : (
                ...
                <thead className="text-theme-text-secondary text-xs leading-[18px] font-bold uppercase border-theme-border border-b">
                  <tr>
                    <th scope="col" className="px-4 py-2 rounded-tl-lg">
                      {t("system-prompt-variables.table.key")}
                    </th>
                    <th scope="col" className="px-4 py-2">
                      {t("system-prompt-variables.table.value")}
                    </th>
                    <th scope="col" className="px-4 py-2">
                      {t("system-prompt-variables.table.description")}
                    </th>
                    <th scope="col" className="px-4 py-2">
                      {t("system-prompt-variables.table.type")}
                    </th>
                  </tr>
                </thead>
                <tbody>
