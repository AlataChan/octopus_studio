...
const UNAVAILABLE_SEARCH_PROVIDER = {
  name: "Unavailable web search provider",
  value: "unavailable",
  logo: OctopusStudioIcon,
  options: () => <React.Fragment />,
  description:
    "The saved web search provider is no longer available. Choose a supported provider to continue.",
};
...
export default function AgentWebSearchSelection({
  ...
  const selectedSearchProviderObject =
    ...
    UNAVAILABLE_SEARCH_PROVIDER;
  const selectedSearchProviderAvailable = SEARCH_PROVIDERS.some(
    ...
    <div className="p-2">
      <div className="flex flex-col gap-y-[18px] max-w-[500px]">
        ...
        <div hidden={!enabled}>
          ...
          {selectedProvider !== "none" && selectedSearchProviderAvailable && (
