            ...
            <div className="px-7 py-6">
              <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2">
                ...
                <div className="flex flex-col w-full">
                  <div className="border border-red-800 bg-theme-bg-secondary light:bg-red-200/50 p-4 rounded-lg flex items-center gap-x-2 text-sm text-red-400 light:text-red-500">
...
function DBEngine({ provider, active, onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`flex flex-col p-4 border border-white/40 bg-theme-bg-secondary light:bg-theme-settings-input-bg rounded-lg w-fit hover:bg-zinc-700 ${
