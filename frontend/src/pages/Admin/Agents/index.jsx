        ...
        >
          ...
          >
            ...
            <div className="text-theme-text-primary flex items-center gap-x-2">
              <Plug size={24} />
              <p className="text-lg font-medium">
                {t("agent.skill.custom-skills-title")}
              </p>
            </div>
            <ImportedSkillList
            ...
            <div className="text-theme-text-primary flex items-center gap-x-2 mt-6">
              <FlowArrow size={24} />
              <p className="text-lg font-medium">
                {t("agent.skill.agent-flows-title")}
              </p>
            </div>
            <AgentFlowsList
              flows={agentFlows}
              ...
              <div className="flex flex-col h-full">
                <div className="flex items-center p-4">
                  <button
                    ...
                    className="text-white/60 hover:text-theme-text-primary transition-colors duration-200"
                  >
      ...
      >
        ...
        <div className="flex flex-col min-w-[360px] h-[calc(100vh-90px)]">
          <div className="flex-none mb-4">
            <div className="text-theme-text-primary flex items-center gap-x-2">
              <Robot size={24} />
              <p className="text-lg font-medium">系统默认技能</p>
            </div>
            <p className="text-sm text-theme-text-secondary mt-1">
              这些能力通过内置工具实现，对所有默认 Agent 生效
            </p>
          </div>

          <div className="flex-1 overflow-y-auto pr-2 pb-4">
            <div className="space-y-4">
              {/* Always-on skills (Layer 1 & 2) */}
              <div className="text-theme-text-secondary text-xs mb-2">
                基础能力（始终启用）
              </div>
              <AlwaysOnSkillList
              ...
              {/* Default skills list */}
              <div className="text-theme-text-secondary text-xs mb-2 mt-4">
                核心能力（可关闭）
              </div>
              <SkillList
                skills={defaultSkills}
              ...
              <div className="text-theme-text-primary flex items-center justify-between gap-x-2 mt-4">
                <div className="flex items-center gap-x-2">
                  <FlowArrow size={24} />
                  <p className="text-lg font-medium">AI 员工流程</p>
                </div>
                {agentFlows.length === 0 ? (
                  <Link
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative z-[1] md:ml-[2px] md:mr-[16px] md:my-[16px] md:rounded-[16px] w-full h-full flex"
      >
        {children}
        <ContextualSaveBar
          showing={hasChanges}
...
/**
 * 始终启用技能列表 - 显示不可关闭的系统级和输出级工具
 */
function AlwaysOnSkillList({
  skills = {},
  selectedSkill = null,
  handleClick = null,
}) {
    ...
    >
      {Object.entries(skills).map(([skill, settings], index) => (
        ...
        >
          <div className="text-sm font-light">{settings.title}</div>
          <div className="flex items-center gap-x-2">
            <span className="text-xs text-green-400 font-medium">始终启用</span>
            <CaretRight
              size={14}
              weight="bold"
              className="text-theme-text-secondary"
