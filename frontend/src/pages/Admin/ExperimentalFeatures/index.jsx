...
function FeatureItem({
  ...
  isActive = false,
  handleClick = () => {},
  borderClass = "border-b border-theme-border",
}) {
  return (
    <div
      key={feature.key}
...
function FeatureVerification({ children }) {
  const tosKey = "alata_tos_experimental_feature_set";
  if (!getLocalStorageItem(tosKey)) {
    function acceptTos(e) {
      e.preventDefault();

      setLocalStorageItem(tosKey, "accepted");
      showToast(
            ...
            <form onSubmit={acceptTos}>
              <div className="py-7 px-9 space-y-4 flex-col">
                <div className="w-full text-theme-text-primary text-md flex flex-col gap-y-4">
                  <p>
                    Experimental features of Octopus Studio are features that we are
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>Potential bugs or issues using Octopus Studio.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>
                        ...
                        configurations, or subscriptions of Octopus Studio.
                      </li>
                      <li>
