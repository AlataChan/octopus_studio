...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Octopus Studio funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao Octopus Studio",
      description: "Ajude-nos a melhorar o Octopus Studio. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o Octopus Studio?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o Octopus Studio?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Crie seu primeiro workspace e comece a usar o Octopus Studio.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Você está no caminho para se tornar um expert em Octopus Studio!",
      dismiss: "fechar",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do Octopus Studio",
    },
    pfp: {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do Octopus Studio com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o Octopus Studio.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o Octopus Studio lidam com seus dados.",
    llm: "Seleção de LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do Octopus Studio. Não são compartilhados com terceiros.",
    },
    pinning: {
