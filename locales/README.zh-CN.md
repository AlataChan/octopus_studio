...
<p align="center">
  ...
  <a href="https://github.com/AlataChan/octopus_studio.git" target="_blank">
    文档
  </a> |
...
## AnythingLLM的一些酷炫特性
- 🆕 [**完全兼容 MCP**](https://github.com/AlataChan/octopus_studio.git)
- 🆕 [**无代码AI代理构建器**](https://github.com/AlataChan/octopus_studio.git)
- 🖼️ **多用户实例支持和权限管理（支持封闭源和开源LLM！）**
- [**自定义人工智能代理**](https://github.com/AlataChan/octopus_studio.git)
